...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [ 72.613508, 23.000937 ],
    // zoom: 10,
    // interactive: false

  });
  var bounds = new mapboxgl.LngLatBounds(); // we create the bounds which represent the lat lng location
  ...
  locations.forEach(function (l) {
    ...
    new mapboxgl.Popup({
      ...
      offset: 30
    }).setLngLat(l.coordinates).setHTML("<p>Day ".concat(l.day, " : ").concat(l.description, "</p>")) // adding the html content which will be displayed on the popup
    .addTo(map); // extend mapbounds to include current location
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"ADlogin.js":[function(require,module,exports) {
"use strict";
...
var uname = document.querySelector('#loginUsername').value;
var upass = document.querySelector('#loginPassword').value;
...
if (loginForm) {
  document.querySelector('#loginForm').addEventListener('submit', function (e) {
    ...
    (0, _ADlogin.checkLogin)(uname, upass);
  });
}
...
},{"./mapbox":"mapbox.js","./ADlogin":"ADlogin.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6629" + '/');
